...
try:
    ...
    print("Error: USA_Housing.csv not found. Please make sure the file is in the correct directory.")
    exit()
...
# imputer_original = SimpleImputer(strategy='mean') #No missing values in the dataset
