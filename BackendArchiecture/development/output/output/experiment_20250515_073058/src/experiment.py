...
try:
    ...
    print(f"Error importing libraries: {e}. Please make sure you have scikit-learn, xgboost installed.")
    exit()
...
# Split data into training and testing sets
X_train_xgb, X_test_xgb, y_train_xgb, y_test_xgb = train_test_split(X_no_na, y_no_na, test_size=0.2, random_state=42)
...
print("RMSE on XGBoost model:", rmse_xgb)